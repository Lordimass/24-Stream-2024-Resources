...
def scrape(campaign_name):
    ...
    results = results.find("main", class_="campaign-page_campaign__IqwZ7 t-campaign-page-template-content hrt-global-wrapper")
    results = results.find("div", class_="p-campaign")
    results = results.find("div", class_="p-campaign-sidebar")
    results = results.find("aside", class_="campaign-sidebar_sidebar__cbHAh o-campaign-sidebar")
    results = results.find("div", class_="campaign-sidebar_wrapper__xX_1x")
